        ...
        <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
          ...
          <form onSubmit={handleSendEmail} className="space-y-3.5">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-[#5cb028] hover:bg-[#4e9921] disabled:bg-[#5cb028]/40 disabled:cursor-not-allowed text-white text-xs font-bold shadow-md shadow-[#5cb028]/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
              {isSending ? (
                <>
