      ...
      <header className="sticky top-0 z-30 h-16 bg-white/80 dark:bg-[#0b0f17]/90 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800 px-4 sm:px-6 flex items-center justify-between gap-4 transition-colors duration-200">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="p-2 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 lg:hidden cursor-pointer"
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          <div className="relative shrink-0" ref={dropdownRef}>
            <button
              ...
              aria-haspopup="true"
              className="flex items-center gap-2 sm:gap-2.5 pl-2 sm:pl-2.5 pr-2.5 sm:pr-3 py-1.5 rounded-2xl bg-white dark:bg-slate-900/90 hover:bg-slate-50/90 dark:hover:bg-slate-800 border border-slate-200/90 dark:border-slate-800 shadow-2xs hover:shadow-xs transition-all cursor-pointer select-none"
            >
