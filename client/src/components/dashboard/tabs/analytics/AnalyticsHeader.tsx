    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-3xl bg-white border border-slate-200/80 shadow-xs">
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-xl bg-[#eaf5e3] border border-[#cdeac0] text-[#3d8318] flex items-center justify-center shadow-2xs">
            <BarChart3 className="w-5 h-5 text-[#5cb028]" />
          </div>
          <h2 className="text-lg sm:text-xl font-extrabold text-slate-900 tracking-tight">
            Retrospective Analytics
          </h2>
          <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-[#eaf5e3] text-[#3d8318] border border-[#cdeac0] uppercase tracking-wide">
            Manager View
          </span>
        </div>
      ...
      <div className="flex items-center gap-2.5 flex-wrap sm:flex-nowrap">
        ...
        <div className="relative min-w-[200px] sm:min-w-[240px]">
          ...
          <select
            ...
            className="w-full appearance-none pl-9 pr-8 py-2.5 rounded-xl bg-slate-50/90 border border-slate-200 hover:border-slate-300 text-xs font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#5cb028]/20 focus:border-[#5cb028] transition-all cursor-pointer shadow-2xs disabled:opacity-50"
          >
