...
export const ActionItemsFilters: React.FC<ActionItemsFiltersProps> = React.memo(({
  ...
  return (
    <div className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200/80 shadow-xs space-y-3.5">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none pl-3 pr-8 py-2 rounded-xl bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-700 hover:border-slate-300 focus:outline-hidden cursor-pointer"
            >
      ...
      <div className="flex items-center gap-1 pt-1 border-t border-slate-100 overflow-x-auto">
        {[
