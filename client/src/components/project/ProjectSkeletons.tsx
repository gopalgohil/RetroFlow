        ...
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-2 flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <div className="h-6 w-52 sm:w-72 rounded-lg bg-slate-200 dark:bg-slate-800" />
            ...
            <div className="space-y-1.5 pt-0.5">
              <div className="h-3.5 w-full max-w-xl rounded bg-slate-100 dark:bg-slate-800/80" />
              <div className="h-3.5 w-3/4 max-w-md rounded bg-slate-100 dark:bg-slate-800/80" />
            </div>

            {/* Sub-meta */}
            <div className="flex items-center gap-3 pt-1">
              <div className="h-3 w-32 rounded bg-slate-200/80 dark:bg-slate-800" />
              <div className="h-3 w-20 rounded bg-slate-100 dark:bg-slate-800/80" />
              <div className="h-3 w-28 rounded bg-slate-100 dark:bg-slate-800/80" />
            </div>
          </div>
        </div>

        {/* Quick Stats Pill */}
        <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900 p-2 rounded-2xl border border-slate-200/80 dark:border-slate-800 shrink-0">
          <div className="px-3 py-1.5 text-center space-y-1">
            <div className="h-2.5 w-10 mx-auto rounded bg-slate-200 dark:bg-slate-800" />
            <div className="h-4 w-6 mx-auto rounded bg-slate-300 dark:bg-slate-700" />
          </div>
          <div className="h-6 w-px bg-slate-200 dark:bg-slate-800" />
          <div className="px-3 py-1.5 text-center space-y-1">
            <div className="h-2.5 w-10 mx-auto rounded bg-slate-200 dark:bg-slate-800" />
            <div className="h-4 w-6 mx-auto rounded bg-[#cdeac0] dark:bg-[#5cb028]/30" />
          </div>
        </div>
      </div>
          ...
          return (
            <div
              ...
              className={`h-9 ${tab.width} rounded-xl ${
                isSelected ? 'bg-[#5cb028]' : 'bg-slate-100 dark:bg-slate-800'
              }`}
            />
          );
        })}
    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="p-4 rounded-2xl bg-amber-50/60 dark:bg-amber-950/20 border border-amber-200/70 dark:border-amber-900/40 shadow-xs flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <div className="h-7 w-24 rounded-xl bg-white dark:bg-slate-800 border border-amber-200 dark:border-amber-800/60" />
        ...
        {[1, 2, 3, 4].map((i) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="w-8 h-8 rounded-xl bg-slate-100 dark:bg-slate-800/80" />
            </div>
            <div className="h-6 w-32 rounded-lg bg-slate-300 dark:bg-slate-700" />
            <div className="h-2.5 w-full rounded bg-slate-100 dark:bg-slate-800/80 pt-1" />
          </div>
        ))}
      </div>
      ...
      <div className="p-6 rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="h-6 w-24 rounded-full bg-[#eaf5e3] dark:bg-[#5cb028]/20 border border-[#cdeac0] dark:border-[#5cb028]/30" />
        </div>
        <div className="h-3 w-full rounded-full bg-slate-100 dark:bg-slate-800" />
        <div className="grid grid-cols-3 gap-3 pt-2">
          <div className="h-12 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800" />
          <div className="h-12 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800" />
          <div className="h-12 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div className="p-6 rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-4">
          ...
          <div className="space-y-3 pt-1">
            {[1, 2, 3].map((n) => (
              <div key={n} className="h-14 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800" />
            ))}
          </div>
        </div>
        <div className="p-6 rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-4">
...
export const SprintsTabSkeleton: React.FC = () => {
  return (
    <div className="space-y-6 animate-pulse">
      {/* Filter Bar */}
      <div className="p-4 rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200/90 dark:border-slate-800 shadow-xs flex items-center justify-between gap-4">
        <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="h-7 w-20 rounded-lg bg-slate-200 dark:bg-slate-700" />
          ))}
        </div>
      ...
      <div className="space-y-4">
        {[1, 2].map((i) => (
          <div
            key={i}
            className="p-6 rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-4"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1.5">
                  <div className="h-4 w-44 rounded bg-slate-200 dark:bg-slate-800" />
                  <div className="h-3 w-32 rounded bg-slate-100 dark:bg-slate-800/80" />
                </div>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-6 w-20 rounded-full bg-emerald-100/70 dark:bg-emerald-950/40" />
            ...
            <div className="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-800">
              {[1, 2, 3].map((j) => (
                ...
                >
                  <div className="h-3.5 w-64 rounded bg-slate-200 dark:bg-slate-800" />
                  <div className="flex items-center gap-2">
    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="p-5 rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200/90 dark:border-slate-800 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1.5">
          ...
          <div className="h-3.5 w-72 rounded bg-slate-100 dark:bg-slate-800/80" />
        </div>
        <div className="h-10 w-40 rounded-xl bg-[#cdeac0] dark:bg-[#5cb028]/30" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="p-5 rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-4"
          >
            <div className="flex items-center justify-between">
              <div className="h-5 w-20 rounded-full bg-emerald-100/70 dark:bg-emerald-950/40" />
              <div className="h-3.5 w-24 rounded bg-slate-100 dark:bg-slate-800/80" />
            </div>

            <div className="space-y-2">
              <div className="h-5 w-3/4 rounded-lg bg-slate-200 dark:bg-slate-800" />
              <div className="h-3.5 w-full rounded bg-slate-100 dark:bg-slate-800/80" />
            </div>
            ...
            <div className="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
              ...
              <div className="h-8 w-28 rounded-xl bg-[#cdeac0] dark:bg-[#5cb028]/30" />
            </div>
          </div>
        ))}
      </div>
...
export const TeamTabSkeleton: React.FC = () => {
  return (
    <div className="space-y-8 animate-pulse">
      ...
      <div className="p-6 rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-6">
        <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800">
          <div className="space-y-1.5">
            <div className="h-5 w-44 rounded-lg bg-slate-200 dark:bg-slate-800" />
            <div className="h-3 w-64 rounded bg-slate-100 dark:bg-slate-800/80" />
          </div>
          <div className="h-9 w-36 rounded-xl bg-[#cdeac0] dark:bg-[#5cb028]/30" />
        </div>
            ...
            <div key={i} className="py-3.5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="h-2.5 w-48 rounded bg-slate-100 dark:bg-slate-800/80" />
                </div>
              </div>
      ...
      <div className="p-6 rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-5">
        <div className="space-y-1.5 pb-3 border-b border-slate-100 dark:border-slate-800">
          ...
          <div className="h-3 w-60 rounded bg-slate-100 dark:bg-slate-800/80" />
        </div>

        <div className="space-y-4">
          <div className="space-y-2">
            <div className="h-3 w-28 rounded bg-slate-200 dark:bg-slate-800" />
            <div className="h-10 w-full rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800" />
          </div>
          <div className="space-y-2">
            <div className="h-3 w-36 rounded bg-slate-200 dark:bg-slate-800" />
            <div className="h-20 w-full rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800" />
          </div>
          <div className="h-9 w-32 rounded-xl bg-[#cdeac0] dark:bg-[#5cb028]/30" />
        </div>
      </div>
    </div>
  );
